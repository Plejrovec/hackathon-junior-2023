...
export default function Root() {
    return (
      <div className="main">
        <a className="HEAD" href="https://www.brnoid.cz/cs/"><img src={nav}></img></a>
